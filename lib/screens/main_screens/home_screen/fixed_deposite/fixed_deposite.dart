...
import 'package:cbm_one_app/screens/widgets/container/circular_image_text.dart';
import 'package:cbm_one_app/screens/widgets/container/customer_curved_container.dart';
import 'package:cbm_one_app/screens/widgets/custom_tab/custom_tab_bar.dart';
...
class FixedDepositeDetailScreen extends StatelessWidget {
  FixedDepositeDetailScreen({super.key});
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: VisaCardWidget3(
                        ...
                        accountNumber: "A/C 2451344",
                        // isOverdue: true,
                        balancetext: "Current balance",
                        rowleftText: "NextInterest  Payment",
                        rowleftTextValue: "20,000",
                        rowrightText: "Next Interest Date",
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const CustomTabBarwidgetCurved(
                      ...
                      tabKey: 'deposite_service_detail',
                    ),
                    ColumnSpacer(0.02),
                    Consumer<TabBarProviderCurved>(
                      builder: (context, provider, _) {
                        if (provider
                                .getSelectedIndex("deposite_service_detail") ==
                            0) {
                          return _transaction();
                        } else {
                          return _depositeInfo();
                        }
                      },
                    ),
                  ],
